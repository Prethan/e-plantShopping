...
import { addItem } from './CartSlice'; // Make sure the path is correct
...
function ProductList({ onHomeClick }) {
  ...
  dispatch(addItem(product)); // Add the product to the global cart
  ...
  style={{
    backgroundColor: (addedToCart[plant.name] || cart.some(item => item.name === plant.name)) ? '#ccc' : '#4CAF50',
    color: (addedToCart[plant.name] || cart.some(item => item.name === plant.name)) ? '#666' : '#fff',
